...
CREATE TABLE IF NOT EXISTS `intoTheWoodsDB`.`raid` (
  ...
  `edition` SMALLINT NULL DEFAULT NULL,
  `place` TINYTEXT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `intoTheWoodsDB`.`organizer` (
  ...
  `password` BLOB(128) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `intoTheWoodsDB`.`sport` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL DEFAULT NULL,
  `area_type` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
